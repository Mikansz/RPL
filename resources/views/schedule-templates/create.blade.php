...
@section('title', 'Buat Template Jadwal Kerja')
@section('page-title', 'Buat Template Jadwal Kerja')
...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('schedule-templates.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="description" id="description" 
                                      ...
                                      rows="3" placeholder="Deskripsi template jadwal kerja...">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="col-md-3 col-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               id="day_{{ $dayNum }}"
                                               {{ in_array($dayNum, $oldWorkDays) ? 'checked' : '' }}>
                        ...
                        <div class="col-12 mb-3">
                            <div class="card border-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="date_fields" style="{{ old('is_permanent') ? 'display: none;' : '' }}">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('exclude_sundays', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" 
                                                       ...
                                                       {{ old('exclude_holidays', true) ? 'checked' : '' }}>
